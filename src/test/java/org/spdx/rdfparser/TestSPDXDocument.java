...
public class TestSPDXDocument {
    ...
    public void testSPDXAnalysisShouldBeAbleToReadValidRDFaFileWithExplicitBase() {
        try {
        	String fileName = "src/test" + File.separator + "resources" + File.separator + "valid-with-explicit-base.html";
        	File file = new File(fileName);
        	String fullFilePath = file.getAbsolutePath();
            SPDXDocumentFactory.creatSpdxDocument(fullFilePath);
        } catch(Exception e) {
    ...
    public void testSPDXAnalysisShouldBeAbleToReadValidRDFaFileWithoutExplicitBase() {
        try {
        	String fileName = "src/test" + File.separator + "resources" + File.separator + "valid-without-explicit-base.html";
            File file = new File(fileName);
            String fullFilePath = file.getAbsolutePath();
        	SPDXDocumentFactory.creatSpdxDocument(fullFilePath);
        } catch(Exception e) {
