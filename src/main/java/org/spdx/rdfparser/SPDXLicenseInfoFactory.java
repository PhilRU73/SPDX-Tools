 ...
 *
 *  Modified by Edo.Shor [WhiteSource] on Apr 8, 2013.
*/
...
public class SPDXLicenseInfoFactory {
	...
	static final Logger logger = LoggerFactory.getLogger(SPDXLicenseInfoFactory.class);
...
//					}
	...
	private static Properties loadLicenseProperties() {
        ...
        InputStream is = null;
        try {
            is = Thread.currentThread().getContextClassLoader().getResourceAsStream(STANDARD_LICENSE_PROPERTIES_FILENAME);
