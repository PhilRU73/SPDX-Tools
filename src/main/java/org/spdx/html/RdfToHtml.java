...
public class RdfToHtml {
	static final String TEMPLATE_CLASS_PATH = "resources" + "/" + "resources/htmlTemplate";
	static final String TEMPLATE_ROOT_PATH = "resources" + File.separator + "resources/htmlTemplate";
